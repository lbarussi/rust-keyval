...
fn send_and_read_all(stream: &mut TcpStream, payload: &[u8]) -> String {
    ...
    // lê até ficar 200ms sem receber nada, com limite total (segurança)
...
fn main() {
    ...
    // =========================
    // 1) Pipeline: SET + GET no mesmo payload
    // =========================
    let pipeline = b"*3\r\n$3\r\nSET\r\n$1\r\na\r\n$1\r\n1\r\n*2\r\n$3\r\nGET\r\n$1\r\na\r\n";
    ...
    // =========================
    // 2) Fragmentação: GET em 2 partes na MESMA conexão
    // =========================
    let part1 = b"*2\r\n$3\r\nGET\r\n$3\r\nfo";
    let part2 = b"o\r\n";
    ...
    assert_contains("GET t expired", &r, "NULL");
    ...
    println!("KEYS: {:?}", r);
    assert_contains("KEYS", &r, "a");
    assert_contains("KEYS", &r, "b");
    ...
    // seu KEYS retorna "a, b\n" ou "\n" quando vazio — só garante que não tem a/b
    assert_not_contains("KEYS after flush", &r, "a");
    assert_not_contains("KEYS after flush", &r, "b");
    assert_not_contains("KEYS after flush", &r, "ERR");

    println!("✅ tester passed (extended)");
}
